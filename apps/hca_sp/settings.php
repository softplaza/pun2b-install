...
$access = ($User->checkAccess('hca_sp', 20)) ? true : false;
if (!$access)
...
$notifications_options = [
	...
	2 => 'Project completed',
	3 => 'Project removed',
	4 => 'Budget exceeded $5,000',
];

$query = array(
	'SELECT'	=> 'g.g_id, g.g_title, g.hca_fs',
	'FROM'		=> 'groups AS g',
	'WHERE'		=> 'g.g_id > 2',
	'ORDER BY'	=> 'g.g_title'
);
...
$Core->set_page_id('sm_special_projects_settings', 'hca_sp');
