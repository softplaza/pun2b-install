...
$access = ($User->checkAccess('hca_trees', 2)) ? true : false;
if(!$access)
	message($lang_common['No permission']);

$errors = $page_param['param'] = array();
$page_param['param']['page_link'] = $URL->link('hca_trees_new_project');
...
if (isset($_POST['form_sent']))
{
	...
	{
		$job_status = array(1 => 'active', 2 => 'on_hold', 3 => 'completed');
		$new_pid = $DBLayer->insert_values('hca_trees_projects', $form_data);
		
		$flash_message = 'Project #'.$new_pid.' has been created.';
		$FlashMessenger->add_info($flash_message);
		redirect($URL->link('hca_trees_projects', $job_status[$form_data['job_status']]), $flash_message);
	}
}
...
$Core->set_page_title('Create a new Project');
$Core->set_page_id('hca_trees_new_project', 'hca_trees');
...
?>
			...
			<div class="txt-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="txt-box textarea">
					...
					<div class="txt-input"><span class="fld-input"><textarea id="fld<?php echo $page_param['fld_count'] ?>" name="location" cols="55" ><?php echo isset($_POST['location']) ? html_encode($_POST['location']) : '' ?></textarea></span></div>
				</div>
			</div>
			...
			<div class="txt-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="txt-box textarea">
					...
					<div class="txt-input"><span class="fld-input"><textarea id="fld<?php echo $page_param['fld_count'] ?>" name="project_desc" cols="55" ><?php echo isset($_POST['project_desc']) ? html_encode($_POST['project_desc']) : '' ?></textarea></span></div>
				</div>
			</div>
			...
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					...
					<span class="fld-input"><input type="date" name="noticed_date" value=""><img src="<?php echo BASE_URL ?>/img/clear.png" onclick="clearDate(<?php echo $page_param['item_count'] ?>)"></span>
				</div>
			</div>
...
if (isset($_POST['vendor_id']) && $_POST['vendor_id'] == $vendor['id'])
...
?>
			...
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					...
					<span class="fld-input"><input type="text" name="po_number" size="15" value="<?php echo isset($_POST['po_number']) ? html_encode($_POST['po_number']) : '' ?>"></span>
				</div>
			</div>
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					...
					<span class="fld-input"><input type="text" name="total_cost" size="15" value="<?php echo isset($_POST['total_cost']) ? html_encode($_POST['total_cost']) : '0' ?>" placeholder="0.00"></span>
				</div>
			</div>
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					<label for="fld<?php echo ++$page_param['fld_count'] ?>"><span><strong>Start Date</strong></span></label><br>
					<span class="fld-input"><input type="date" name="start_date" value=""><img src="<?php echo BASE_URL ?>/img/clear.png" onclick="clearDate(<?php echo $page_param['item_count'] ?>)"></span>
				</div>
			</div>
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					<label for="fld<?php echo ++$page_param['fld_count'] ?>"><span><strong>End Date</strong></span></label><br>
					<span class="fld-input"><input type="date" name="end_date" value=""><img src="<?php echo BASE_URL ?>/img/clear.png" onclick="clearDate(<?php echo $page_param['item_count'] ?>)"></span>
				</div>
			</div>
			...
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box text">
					...
					<span class="fld-input"><input type="date" name="completion_date" value=""><img src="<?php echo BASE_URL ?>/img/clear.png" onclick="clearDate(<?php echo $page_param['item_count'] ?>)"></span>
				</div>
			</div>
			<div class="txt-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="txt-box textarea">
					<label for="fld<?php echo ++$page_param['fld_count'] ?>"><span>Remarks</span><small>Leave your comment</small></label>
					<div class="txt-input"><span class="fld-input"><textarea id="fld<?php echo $page_param['fld_count'] ?>" name="remarks" cols="55" ><?php echo isset($_POST['remarks']) ? html_encode($_POST['remarks']) : '' ?></textarea></span></div>
				</div>
			</div>
			<div class="sf-set set<?php echo ++$page_param['item_count'] ?>">
				<div class="sf-box select">
...
foreach ($work_statuses as $key => $status) {
	if (isset($_POST['job_status']) && $_POST['job_status'] == $key)
