...
<?php
	...
	foreach ($topics as $cur_topic)
	{
		...
		if ($cur_topic['moved_to'] !== null)
		{
			...
			$forum_page['item_body']['subject']['title'] = '<h6 class="hn"><span class="item-num">'.forum_number_format($forum_page['start_from'] + $forum_page['item_count']).'</span>'.$forum_page['item_title']['link'].'</h6>';
		...
		else
		{
			...
			$forum_page['item_body']['subject']['title'] = '<h6 class="hn"><span class="item-num">'.forum_number_format($forum_page['start_from'] + $forum_page['item_count']).'</span> '.implode(' ', $forum_page['item_title']).'</h6>';
...
{
	$forum_page['item_body']['subject']['title'] = '<h6 class="hn">'.$lang_forum['No topics'].'</h6>';
