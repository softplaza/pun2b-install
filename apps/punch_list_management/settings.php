...
$access = ($User->checkAccess('punch_list_management', 20)) ? true : false;
if (!$access)
	message($lang_common['No permission']);

// Main Settings
$rules_to = 'punch_list_management';
...
$Core->set_page_id('punch_list_management_settings', 'punch_list_management');
