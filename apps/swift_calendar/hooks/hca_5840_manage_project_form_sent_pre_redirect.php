...
$event_text = 'Property: '.$property_name.', unit#: '.$unit_number.', location: '.$location.'. Source: '.$form_data['mois_source'].'. Symptoms: '.$form_data['symptoms'].'. ';

if ($main_info['mois_inspection_date'] == 0 && $form_data['mois_inspection_date'] > $time_now)
{
...
if ($main_info['asb_test_date'] == 0 && $form_data['asb_test_date'] > $time_now)
{
...
if ($main_info['rem_start_date'] == 0 && $form_data['rem_start_date'] > $time_now)
{
...
if ($main_info['cons_start_date'] == 0 && $form_data['cons_start_date'] > $time_now)
{
...
if ($main_info['rem_end_date'] == 0 && $form_data['rem_end_date'] > $time_now)
{
...
if ($main_info['cons_end_date'] == 0 && $form_data['cons_end_date'] > $time_now)
{
