...
$access = ($User->checkAccess('hca_mi', 14) || $User->get('hca_5840_access') > 0) ? true : false;
if (!$access)
...
?>
				...
				<button type="submit" name="upload_file" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete selected files?')">Delete files</button>
			</div>
		</div>
	</form>
