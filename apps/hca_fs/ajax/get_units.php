...
if (!empty($units_info))
{
	$json_array['units'] = '<input type="text" name="unit_number" list="units_list" class="form-control" placeholder="Select/Enter unit #">'."\n";
	$json_array['units'] .= '<datalist id="units_list">'."\n";
	$json_array['units'] .= '<option value="Common area">'."\n";
...
{
	echo json_encode(array(
		'unit_number' => '<input type="text" name="unit_number" value="" placeholder="Enter unit #" class="form-control">',
	));
}
