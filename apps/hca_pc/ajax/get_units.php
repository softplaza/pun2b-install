...
if (!empty($units_info))
{
	if (isset($project_info['unit_number']))
		$json_units .= '<input type="text" name="unit_number" value="'.html_encode($project_info['unit_number']).'" placeholder="Enter Unit#" list="unit_numbers"/>'."\n";
	else
		$json_units .= '<input type="text" name="unit_number" value="" placeholder="Enter Unit#" list="unit_numbers"/>'."\n";
