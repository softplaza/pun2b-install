...
$Core->set_page_title('Vendors upcoming works');
$Core->set_page_id('sm_vendors_calendar', 'sm_vendors');
...
.th-day{background:#999999;font-weight: bold;color: #fff;}
...
.ct-group td .alert-red, .warn-box .alert-red{background: red;color: white;padding: 2px;}
.alert-pink{background: pink;color: #473d3d;padding: 2px;}
...
<div class="main-content main-frm">
	<div class="ct-box warn-box">
		<p><strong>Legends: </strong><span class="alert-red">No vendor</span><span class="alert-pink">Duplicate</span></p>
	</div>
...
function getEvents(date) {
	var csrf_token = "<?php echo generate_form_token($URL->link('sm_vendors_ajax_get_events')) ?>";
	jQuery.ajax({
		url:	"<?php echo $URL->link('sm_vendors_ajax_get_events') ?>",
		type:	"POST",
		dataType: "json",
		cache: false,
