...
{
	public $search_query = [];
	public $hca_hvac_inspections_checklist_items = [];
	...
	function getCheckedItems()
	{
		...
		if (!empty($this->search_query)) 
		{
			if (!empty($this->hca_hvac_inspections_checklist_items))
			{
				foreach($this->hca_hvac_inspections_checklist_items as $cur_info)
				{
