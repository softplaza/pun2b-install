...
function hca_hvac_inspections_IncludeCommon()
{
    ...
    if ($User->checkAccess('hca_hvac_inspections'))
    {
        ...
        if ($User->checkAccess('hca_hvac_inspections', 20))
            $SwiftMenu->addItem(['title' => '+ New inspection 2', 'link' => $URL->link('hca_hvac_inspections_checklist2', 0), 'id' => 'hca_hvac_inspections_checklist2', 'parent_id' => 'hca_hvac_inspections', 'level' => 2]);
...
?>
        <div class="card-body pt-1 pb-1">
            <h6 class="h6 card-title mb-0">HVAC Inspections</h6>
<?php
