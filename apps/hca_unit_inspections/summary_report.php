...
?>
		<tr>
			<td>
				<a href="<?php echo $URL->link('hca_ui_summary_report', 'property_id='.$cur_info['id']) ?>" class="fw-bold"><?php echo html_encode($cur_info['pro_name']) ?></a>
				<a href="<?php echo $URL->link('hca_ui_summary_report', 'property_id='.$cur_info['id']) ?>" class="badge bg-primary float-end text-white">View</a>
		</td>
...
?>
				...
				<div class="col-md-auto">
					...
					<a href="<?php echo $URL->link('hca_ui_summary_report', 'property_id='.$search_by_property_id) ?>" class="btn btn-sm btn-outline-secondary">Reset</a>
				</div>
			</div>
		</div>
	</form>
...
<?php
	...
	if (!empty($hca_ui_checklist_dates))
	{
		...
		foreach($hca_ui_checklist_dates as $key => $value)
		{
			...
			$checklist_date_links[] = '<a href="'.$URL->link('hca_ui_summary_report', $sub_link).'" class="btn btn-outline-primary" role="button">'.$key.'</a>';
		}
	}
?>
...
?>
		<tr class="">
			<td class="fw-bold"><a href="<?=$URL->link('hca_ui_summary_report', $sub_link)?>"><?=$item_name?></a></td>
