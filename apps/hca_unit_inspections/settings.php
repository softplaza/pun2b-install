...
$access = ($User->checkAccess('hca_unit_inspections', 20)) ? true : false;
if (!$access)
	message($lang_common['No permission']);

$rules_to = 'hca_unit_inspections';
$access_options = [
	1 => 'New CheckList',
	2 => 'Work Order',
...
$Core->set_page_id('hca_unit_inspections_settings', 'hca_unit_inspections');
