...
$access = ($User->checkAccess('hca_ui')) ? true : false;
if (!$access)
...
if ($id > 0 && $key != '')
{
	...
	{
		$query = array(
			'UPDATE'	=> 'hca_ui_checklist_kitchen',
			'SET'		=> ''.$key.'='.$val,
