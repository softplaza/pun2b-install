...
$access = ($User->checkAccess('hca_cc', 50)) ? true : false;
if (!$access)
...
$notifications_options = [
	1 => 'Receive upcoming reminder by email',
	2 => 'Receive email if item was completed',
];
...
$Core->set_page_id('hca_ui_settings', 'hca_ui');
