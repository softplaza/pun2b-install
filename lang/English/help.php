...
'BBCode info'			=>	'Administrators have the ability to enable or disable BBCode. If BBCode is enabled a link to BBCode help will appear when you compose/edit a post or your signature. BBCode is a collection of formatting tags that are used to change the look of text in this page. BBCode is based on the same principal as, and is very similar to, HTML. Below is a list of all the available BBCodes and instructions on how to use them.',
...
'Smilies info'			=>	'If you like (and if it is enabled), the site can convert a selection of smilies to image representations of those smilies. This site recognizes the smilies listed below and replaces them with images.'
