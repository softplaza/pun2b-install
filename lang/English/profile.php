...
'Delete posts label'		=>	'Delete any projects %s has made.',
'Group membership redirect'	=>	'Group membership updated.',
'Moderate forums redirect'	=>	'System manager rights updated.',
'Ban redirect'				=>	'Redirecting…',
'Ban user'					=>	'Ban user',
'Ban user info'				=>	'Ban this user via the administration console.',
'Delete user info'			=>	'Permanently delete this user and, optionally, all their projects.',
'User management'			=>	'User management',
'Group membership'			=>	'Group membership',
'User group'				=>	'Assign user to group',
'Moderator assignment'		=>	'System manager assignment',
...
'Update forums'				=>	'Update manager assignment',
...
'Move failed'				=>	'The server was unable to save the uploaded file. Please contact the site administrator at %s.',
...
'View your forum subscriptions'	=>	'View all your page subscriptions',
'View user forum subscriptions'	=>	'View all %s\'s page subscriptions',
'Realname'					=>	'Real name',
...
'Title'						=>	'Title',
'Leave blank'				=>	'Leave blank to use page default.',
...
'Pass key bad'				=>	'The specified password activation key was incorrect or has expired. Please re-request a new password. If that fails, contact the site administrator at %s.',
...
'E-mail key bad'			=>	'The specified email activation key was incorrect or has expired. Please re-request change of email address. If that fails, contact the site administrator at %s.',
...
'Activate e-mail sent'		=>	'An email has been sent to the specified address with instructions on how to activate the new email address. If it doesn\'t arrive you can contact the site administrator at %s.',
'Change your e-mail'		=>	'Change your email address',
'Change user e-mail'		=>	'Change %s\'s email address',
'New e-mail'				=>	'New email address',

// Signatures
'Sig welcome'				=>	'Create or modify a signature for display in your Email',
'Sig welcome user'			=>	'Create or modify a signature for display in %s\'s Email',
...
'No new regs'				=>	'This site is not accepting new registrations.',
...
'Banned e-mail'				=>	'The email address you entered is banned in this site. Please choose another email address.',
'Dupe e-mail'				=>	'Someone else is already registered with that email address. Please choose another email address.',
'Reg e-mail'				=>	'Thank you for registering. An email has been sent to the specified address with instructions on how to activate your new account. If it doesn\'t arrive you can contact the site administrator at %s.',
...
'Register intro'			=>	'Registration enables you to use features not available when browsing the board as a guest. The fields below only make up a small part of all the settings you can alter in your profile. If you have any questions regarding this site you should ask an administrator. Please complete the form below in order to register.',
'Username'					=>	'Username',
...
'E-mail setting 2'			=>	'Hide your email address but allow email via the site.',
'E-mail setting 3'			=>	'Hide your email address and disallow email via the site.',
'Reg rules head'			=>	'You must agree to the site rules set out below in order to register.',
...
'Username BBCode'			=>	'Usernames may not contain any of the text formatting tags (BBCode) that the site uses. Please choose another username.',
