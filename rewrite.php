...
if (file_exists(SITE_ROOT.'include/url/'.$Config->get('o_sef').'/rewrite_rules.php'))
	require SITE_ROOT.'include/url/'.$Config->get('o_sef').'/rewrite_rules.php';
else
	require SITE_ROOT.'include/url/Default/rewrite_rules.php';
...
{
	$Hooks->get_hook('RewriteEmpty');

	define('SPM_HTTP_RESPONSE_CODE_SET', 1);
	header('HTTP/1.1 404 Not Found');

	error('Page Not Found (Error 404):<br />The requested page <em>'.html_encode($request_uri).'</em> could not be found.');
}
